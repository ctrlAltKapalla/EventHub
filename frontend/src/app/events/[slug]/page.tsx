  ...
  if (error || !event) {
    return (
      <div className="max-w-7xl mx-auto px-4 py-20 text-center">
        ...
        <p className="text-neutral-600 mb-6">{error ?? "Dieses Event existiert nicht oder wurde entfernt."}</p>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {[
              ...
              { icon: "🎟️", label: "Kapazität", value: `${event.registrations_count} / ${event.capacity} Plätze belegt`, sub: isAlmostFull ? `⚠️ Nur noch ${spotsLeft} Plätze frei!` : undefined },
